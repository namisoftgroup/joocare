        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <form>
                <DialogContent className="max-w-175 flex flex-col  gap-5">
                    ...
                    <DialogDescription className="text-sm text-muted-foreground -mt-2">You can write about your years of experience, industry, or skills. People also talk about their achievements or previous job experiences</DialogDescription>
